...
const ImageB: React.FC<ImageBannerProps> = ({ hero }) => {
  return (
    ...
    >
      ...
      {/* ================= FIXED CONTENT ================= */}
      <div className="absolute inset-0 z-20 flex items-end pb-16 lg:pb-10">
        <Container>
          <div className="flex flex-col gap-6">
            <div className="grid lg:grid-cols-[1.2fr_1fr] grid-cols-1">
              <div className="space-y-2 w-full text-left">

                <p className="flex mx-0 bg-white/20 backdrop-blur-2xl items-center gap-2 text-[10px] sm:text-xs text-white w-fit border border-primary py-1 px-2.5 rounded-full uppercase tracking-widest">
                  {hero.tag}
                </p>

                <h1
                  className="font-primary text-xl sm:text-2xl md:text-5xl text-white md:max-w-6xl"
