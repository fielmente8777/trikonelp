...
const Ethos = ({
  ...
  return (
    <Section defaultPadding={false} className="relative w-full overflow-hidden">
      {/* BACKGROUND IMAGE */}
      <div className="relative aspect-[1.5/1] min-h-[400px] w-full md:aspect-[3/1] md:min-h-[651px]">
        ...
        {/* CONTENT */}
        <div className="hidden absolute inset-0 z-10 max-md:px-4  md:flex items-center">
